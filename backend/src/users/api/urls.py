...
from .views import AccountViewSet, GraduateProfileViewSet, UploadFileView, VerifyInformationView, StatusView, StaffRegisterView, StaffGraduateListView, StaffGraduateView, StaffGetDocumentView
...
urlpatterns = [
	...
	path('staff/graduate-data/<pk>/documents/<keyname>/',StaffGetDocumentView.as_view()),
]
