                ...
                >
                    ...
                    >
                        <div style={{width: "80%"}}>
                            ...
                            <Form.Item name="titulation_type" label="Opc. Titulación" rules={rules()}>
                                <Input/>
                            </Form.Item>
                    ...
                    >
                        <div style={{width: "80%"}}>
                            ...
                            <Form.Item name="record_date" label="Fecha autorización" rules={rules()} hasFeedback={true}>
                                <DatePicker/>
                            </Form.Item>
                    ...
                    <Card style={{
                        ...
                        <div style={{width: "80%",}}>
                            ...
                            <Form.Item name="services_lead" label="Jefe(a) S.E." rules={rules()}>
                                <Input/>
                            </Form.Item>
