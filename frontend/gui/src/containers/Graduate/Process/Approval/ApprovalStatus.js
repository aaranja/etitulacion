  ...
  render() {
    return (
      <Result
        ...
        subTitle="Asegurese de que toda su documentación e información sea correcta antes de iniciar el trámite"
        extra={[
          <Button
            type="primary"
            key="done"
            ...
            onClick={() => {
              this.props.onPressButton("init", "Trámite iniciado");
            }}
          >
            Iniciar trámite
          </Button>,
...
export class InProcess extends Component {
  cancel = (cancel) => {
    confirm({
      title: "Trámite en proceso. Desea cancelarlo?",
      ...
      cancelText: "No",
      onOk() {
        cancel("cancel", "Trámite cancelado");
      },
      onCancel() {
        console.log("Cancel");
      },
