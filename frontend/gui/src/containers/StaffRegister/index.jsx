...
import { PageHeader, Divider, Form, Input, Button, Card, Select } from "antd";
		...
		return (
			...
			>
				<PageHeader
					...
					subTitle="Staff"
				/>
				<Divider orientation="center">Formulario</Divider>
				<Card
					style={{
						width: 500,
					}}
							...
							rules={[
								{
									required: true,
									message:
										"Por favor introduce el número de control!",
								},
							]}
						>
							...
							rules={[
								{
									required: true,
									message:
										"Por favor seleccione el tipo de staff!",
								},
							]}
						>
