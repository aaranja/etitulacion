...
export const getGraduateList = () => {
  return async (dispatch) => {
    ...
    if (isLogged(token)) {
      ...
      await axios
        .get(`http://127.0.0.1:8000/staff/graduate-list/`)
        .then((response) => {
...
export const getFilteredList = (filters) => {
  ...
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .post(`http://127.0.0.1:8000/staff/graduate-list/`, filters)
        .then((response) => {
          dispatch(actionSuccess({ tableData: response.data }));
        })
        .catch((error) => {
  ...
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios({
        method: "get",
        Authorization: `Token ${token}`,
        url: `http://127.0.0.1:8000/staff/graduate-data/${enrollment}/documents/${keyName}/`,
...
export const setApproval = (enrollment, message, type) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .post(`http://127.0.0.1:8000/staff/graduate-data/${enrollment}/`, {
          message: message,
          type: type,
        })
        .then((response) => {
...
export const getGraduate = (enrollment) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .get(`http://127.0.0.1:8000/staff/graduate-data/${enrollment}/`)
        .then((response) => {
          dispatch(
            actionSuccess({
...
export const getDocumentsDetails = (type) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .post(`http://127.0.0.1:8000/api/procedure/documents-metadata/`, {
          type: type,
        })
        .then((response) => {
...
export const uploadSignatureFiles = (data) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .put(
          `http://127.0.0.1:8000/staff/services/settings/signature/`,
          formData,
          {
            headers: {
              Authorization: `Token ${token}`,
...
export const getAccountDetails = () => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .get("http://127.0.0.1:8000/staff/services/settings/account-details/")
        .then((response) => {
          /*dispatch all data*/
...
export const createGroupDate = (values) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .post("http://127.0.0.1:8000/staff/coordination/group-date/", {
          groupDate: values,
        })
        .then((response) => {
          /*dispatch all data*/
...
export const updateGroupDate = (values) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .patch("http://127.0.0.1:8000/staff/coordination/group-date/", {
          groupDate: values,
        })
        .then((response) => {
          /*dispatch all data*/
...
export const deleteGroupDate = (values) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      dispatch(actionStart());
      await axios
        .delete("http://127.0.0.1:8000/staff/coordination/group-date/", {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Token ${token}`,
          },
...
export const getDateGroup = (type) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      dispatch(actionStart());
      await axios
        .get(`http://127.0.0.1:8000/staff/coordination/group-date/`, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Token ${token}`,
          },
...
export const getARPGroup = (id) => {
  ...
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .get(`http://127.0.0.1:8000/staff/coordination/arp-group/`, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Token ${token}`,
          },
...
export const createARPGroup = (id) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .post(`http://127.0.0.1:8000/staff/coordination/arp-group/`, {
          id: id,
        })
        .then((res) => {
          dispatch(staffActionSuccess("arpGroup", "get", res.data));
...
export const saveARPGroup = (values) => {
  ...
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .patch(`http://127.0.0.1:8000/staff/coordination/arp-group/`, values)
        .then((res) => {
          console.log(res.data);
...
export const deleteARPGroup = (id) => {
  ...
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .delete(`http://127.0.0.1:8000/staff/coordination/arp-group/`, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Token ${token}`,
          },
...
export const getARPStaff = () => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      dispatch(actionStart());
      await axios
        .get(`http://127.0.0.1:8000/staff/coordination/arp-staff/`, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Token ${token}`,
          },
...
export const createARPStaff = (data) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .post(`http://127.0.0.1:8000/staff/coordination/arp-staff/`, {
          arpStaffData: data,
        })
        .then((res) => {
...
export const updateARPStaff = (data) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .patch(`http://127.0.0.1:8000/staff/coordination/arp-staff/`, {
          arpStaffData: data,
        })
        .then((res) => {
...
export const deleteARPStaff = (data) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      dispatch(actionStart());
      await axios
        .delete(`http://127.0.0.1:8000/staff/coordination/arp-staff/`, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Token ${token}`,
          },
...
export const getAEPGraduate = (enrollment) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      dispatch(staffActionStart(name, action));
      await axios
        .get(`http://127.0.0.1:8000/staff/services/aep-graduate/`, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Token ${token}`,
          },
  ...
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios({
        ...
        url: `http://127.0.0.1:8000/staff/services/aep-graduate/`,
        responseType: "arraybuffer",
        responseEncoding: "binary",
        data: { aepData: data },
      })
...
export const uploadAEPFile = (file, metadata, enrollment) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .patch(`http://127.0.0.1:8000/staff/services/aep-graduate/`, formData, {
          headers: {
            Authorization: `Token ${token}`,
            "Content-type": "multipart/form-data",
          },
...
export const deleteAEPFile = (enrollment) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      dispatch(staffActionStart(name, action));
      await axios
        .delete(`http://127.0.0.1:8000/staff/services/aep-graduate/`, {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Token ${token}`,
          },
...
export const setLiberation = (enrollment, type) => {
  return async (dispatch) => {
    ...
    if (token === undefined) {
      ...
      await axios
        .patch(`http://127.0.0.1:8000/staff/services/aep-liberation/`, {
