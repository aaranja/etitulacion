...
const actionStart = (state, action) => {
  ...
  switch (action.action) {
    case "get":
      ...
      break;
    case "put":
      payload[dataName] = put_start(payload[dataName].data);
      break;
    case "update":
...
const actionSuccess = (state, action) => {
  ...
  switch (action.action) {
    case "get":
      ...
      break;
    case "put":
      payload[dataName] = put_success(payload[dataName].data, data);
      break;
    case "update":
...
const actionFail = (state, action) => {
  ...
  switch (action.action) {
    case "get":
      ...
      break;
    case "put":
      payload[dataName] = put_failed(payload[dataName].data);
      break;
    case "delete":
...
const put_start = (data) => {
  return { data: data, status: "start", action: "put" };
};

const put_success = (oldData, newData) => {
  return {
    data: newData,
    status: "success",
    action: "put",
